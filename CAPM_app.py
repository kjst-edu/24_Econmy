...
with ui.sidebar():
    ui.input_text('ticker', '銘柄コードを入力してください', placeholder=7203)
    ui.input_password("api_key", "API KEYを入力してください", placeholder="Enter EDINET API KEY")
    ui.input_slider('return_rate', '目標収益率', min=0, max=100, post='%', value=10)
...
def _():
    risk_free_rate.set(get_risk_free_rate(input.api_key()))
